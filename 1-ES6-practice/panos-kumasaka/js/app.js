...
function displayPics(){
  ...
  // let constrains the variable given to the closest upwards containing structure.
  // var does the same but with variables. Hence let constrained itself to the while loop while var would stick to the function containing the loop.
  console.log(viewed)
